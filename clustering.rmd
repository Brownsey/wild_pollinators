...
#When temperature isn't added in then they don't
logged_data <- data_2012 %>%
  inner_join(clusterings) %>%
...
### Final Confounders
Based on the analysis above, the confounders to be taken into account are:
